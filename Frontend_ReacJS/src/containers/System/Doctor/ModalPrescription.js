...
class ModalPrescription extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dataPrescription: {}
    ...
    async componentDidMount() {
        if (this.props.dataPrescription) {
            let dataPrescription = this.props.dataPrescription;
            this.setState({
                dataPrescription
    ...
    componentDidUpdate(prevProps, prevState, snapchot) {
        //render => didupate  
        // qua khu >< hien tai
        if (prevProps.dataPrescription !== this.props.dataPrescription) {
            let dataPrescription = this.props.dataPrescription;
            this.setState({
                dataPrescription
    ...
    render() {
        ...
        let { dataPrescription } = this.state;
...
export default connect(mapStateToProps, mapDispatchToProps)(ModalPrescription);
